...
In order to make sure you have enough python knowledge to do well in the Data science course we have borrowed a chalange from Exercism.org.  You need to complete the task described in this Readme and send your .py file as a txt to "kperry@blinksoft.com".    The task is described below in the Introduction. We are not trying to make this difficult so there is plenty of information in this file and others in the folder to help you complete the task.   It is important that you can complete this in order for you to be able to get the maximum  benifit out of the up coming course.  
